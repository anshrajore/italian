...
const MenuCard = ({ item, index }: { item: MenuItem; index: number }) => {
  return (
    <motion.div
      className="group bg-card/50 backdrop-blur-sm rounded-3xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 border border-border/50 flex flex-col"
